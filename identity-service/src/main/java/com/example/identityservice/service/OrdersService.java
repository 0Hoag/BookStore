...
public class OrdersService {
    ...
    //
    //        Set<SelectedProductResponse> selectedProductResponses = selectedProductResponses(selectedProductSet,
    // user);
    //
                ...
                selectedProductRepository.findAllById(request.getSelectedProducts()).stream()
                        .map(selectedProduct -> {
                            ...
                            BookResponse bookResponse =
                                    fetchBookResponse(selectedProduct.getBookId(), generateToken(user));
                            amoutTotal[0] += selectedProduct1.getQuantity() * bookResponse.getPrice();
