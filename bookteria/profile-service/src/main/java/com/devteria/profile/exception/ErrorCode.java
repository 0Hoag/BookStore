...
public enum ErrorCode {
    ...
    USERNAME_IS_MISSING(1009, "Username missing, please enter username", HttpStatus.BAD_REQUEST),
    USERNAME_EXISTED(1010, "Username existed, please choose another one", HttpStatus.BAD_REQUEST),
