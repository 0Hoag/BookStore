...
public interface CommentClient {
        ...
        ApiResponse<CommentResponse> getComment(@PathVariable("commentId") String commentId, @RequestHeader("Authorization") String token);
        ...
        ApiResponse<CommentResponse> updateCommentResponse(@PathVariable("commentId") String commentId, @RequestBody UpdateCommentRequest request, @RequestHeader("Authorization") String token);
}
