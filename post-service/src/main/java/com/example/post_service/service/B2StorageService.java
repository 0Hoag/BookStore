...
public class B2StorageService {
    ...
    public B2StorageService() {
        ...
        this.accountId = "YOU_ACCOUNT_ID";
        this.applicationKey = "YOU_APPLICATION_KEY";
        this.bucketId = "YOU_BUCKET_ID";
    ...
    public String getNativeDownloadUrl(String fileId) throws IOException {
        Request request = new Request.Builder()
                .url(apiUrl + "/b2api/v2/b2_download_file_by_id")
                .header("Authorization", authorizationToken)
                .post(new FormBody.Builder().add("fileId", fileId).build())
                .build();
