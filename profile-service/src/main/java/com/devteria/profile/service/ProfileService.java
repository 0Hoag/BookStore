...
import com.devteria.profile.exception.ErrorKeyCloakException;
...
public class ProfileService {
    ...
    ErrorKeyCloakException errorKeyCloakException;
    @Value("${idp.client-id}")
    @NonFinal
    String clientId;
    ...
    public ProfileResponse register(RegistrationRequest request){
        try {
            ...
            throw errorKeyCloakException.handleErrorKeyCloak(exception);
        }
    }
