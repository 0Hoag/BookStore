...
//        return userProfileResponse;
    ...
    public UserProfileResponse getProfile(String profileId) {
        ...
        UserResponse userResponse = fetchUserInformation(userProfile.getUserId(), token);
...
//    }
    ...
    private UserResponse fetchUserInformation(String userId, String token) {
        ApiResponse<UserResponse> userResponseApiResponse = identityClient.getUser(userId, token);
